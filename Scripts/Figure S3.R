...
fs3 <- ggplot(figdata) +
  ...
  scale_x_continuous("Year",
    limits = c(1980, 2022), expand = c(0, 0), breaks = seq(1980, 2020, 10),
    minor_breaks = seq(1980, 2020, 5), guide = "axis_minor"
  ) +
  scale_y_continuous("Both-sexes mean total length (cm)",
    limits = c(20, 81), expand = c(0, 0), breaks = seq(20, 80, 10),
...
ggsave("Figures/Figure S3.pdf", device = cairo_pdf, width = 6, height = 4)
