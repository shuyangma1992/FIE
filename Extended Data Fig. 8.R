...
# 4 Combine figures -------------------------------------------------------
figure <- ggarrange(fs8a,fs8b,nrow=2,common.legend = T,legend = "right")
annotate_figure(figure, top=text_grob("Spawning stock age structure — NEAC (1946-2020)", family="Calibri",face = "bold"))
ggsave("Figures/Extended Data Fig. 8.pdf",device = cairo_pdf,width = 6,height = 6)
