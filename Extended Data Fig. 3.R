...
# 4 Combine figures ---------------------------------------------------------
figure <- ggarrange(fs3a,fs3b,nrow=2)
annotate_figure(figure, top=text_grob("Cohort analysis — NEAC (1933-2016)", family="Calibri",face = "bold"))
ggsave("Figures/Extended Data Fig. 3.pdf",device = cairo_pdf,width = 6,height = 6)
