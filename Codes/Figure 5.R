...
f5a <- ggplot(fig_abundance,aes(x=freq,y=Year))+
...
f5b <- ggplot(fig_catch,aes(x=freq,y=Year))+
...
# 4 Combine figures -------------------------------------------------------
figure <- ggarrange(f5a,f5b,ncol=2)
ggsave("Figures/Figure 5.pdf",device = cairo_pdf,width = 8,height = 10)
